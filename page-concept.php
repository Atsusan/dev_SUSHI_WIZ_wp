...
<main>
  ...
  <section class="p-concept1">
    ...
    <div class="p-concept1__imgBox">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/concept1-item.jpg" alt="鮨で人を笑顔にしたい 鮨で人を繋げたい" class="p-concept1__img" width="620"
        height="468">
    </div>
  ...
  <section class="p-concept2">
    ...
    <div class="p-concept2__imgBox">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/concept2-item.jpg" alt="新鮮で美味しいお鮨を お手軽な価格で" class="p-concept2__img" width="546"
        height="508">
    </div>
  ...
  <section class="p-concept3">
    ...
    <div class="p-concept3__imgBox">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/concept3-item.jpg" alt="いつでも、どこでも、どなたでも" class="p-concept3__img" width="620"
        height="508">
    </div>
  ...
  <!-- ▼ p-concept4 -->
  <section class="p-concept4">
    <p class="p-concept4__bigText">
      CONCEPT<span class="p-concept4__bigNumber">4</span>
    </p>
    <div class="p-concept4__imgBox">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/concept4-item.webp" alt="鮨文化の素晴らしさを伝えたい" class="p-concept4__img" width="546"
        height="508">
    </div>
    <div class="p-concept4__inner">
      <div class="p-concept4__textBox">
        <h2 class="p-concept4__title">
          鮨文化の素晴らしさを伝えたい
        </h2>
        <p class="p-concept4__text">
          鮨の文化を少しでも皆様にお伝えするため、お子様や外国人観光客向けの「握り体験コース」をご用意致しました。新鮮な食材を自分でお鮨の形に握ってもらい、楽しく、美味しく皆様で食べましょう。<br>
          また、お鮨に合うお酒と言えばやはり日本酒やワインです。日本酒及びワインの利き酒専門資格を取得したスタッフが厳選するお酒が、お鮨の味わいを更に深いものにしてくれます。是非お酒とのペアリングもお試しください。
        </p>
      </div>
    </div>
  </section>
